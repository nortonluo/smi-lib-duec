...
/**
 * Class for representing the dependency element
 *
 * @author Rathish_Das
 */
public class DCMDependency {

    /**
     * Constructor
     */
    public DCMDependency() {
     ...
     * constructed
     */
    public DCMDependency(DCMDependency inDependency) {
        mTargetIdentifiers = new HashSet<>();
     ...
     *
     * @return returns prerequisite identifier
     */
